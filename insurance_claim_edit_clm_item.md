---
title: "Edit a Claim Item"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_claim_edit_clm_item.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Edit a Claim Item

Edit a Claim Item[](https://help.salesforce.com/s?language=en_US)
...
3.  Navigate to the Participants tab and expand the claim participant that you want to edit the claim item for.
4.  Click the dropdown menu of the claim item that you want to edit, and select **Edit**.
5.  Make the necessary changes to the details and attributes of the claim item. However, the Claim, Category, Product, and Claim Instance Identifier fields are not editable.
6.  Save your changes.
