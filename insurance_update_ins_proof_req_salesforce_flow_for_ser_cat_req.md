---
title: "Update the Process Insurance Proof Request Salesforce Flow for Service Catalog Requests"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_update_ins_proof_req_salesforce_flow_for_ser_cat_req.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Update the Process Insurance Proof Request Salesforce Flow for Service Catalog Requests

Update the Process Insurance Proof Request Salesforce Flow for Service Catalog Requests[](https://help.salesforce.com/s?language=en_US)
...
To trigger the Process Insurance Proof Request Salesforce flow only for updates in response to Service Catalog Requests, connect the SvcCatalogItemDefinitionID field to your Request Insurance Proof service process. Update the Start element in the cloned Process Insurance Proof Request Salesforce flow and add your Request Insurance Proof service process API name. When a case is created, a Service Catalog Request is created.
...
2.  Click the cloned Process Insurance Proof Request flow orchestration.
3.  Click the Record-Triggered Orchestration Start element, then click **Edit**.
    ...
    2.  Select **SvcCatalogItemDefinitionId** as the field.
    3.  Select **Equals** as the operator.
    4.  Enter the value of your Service Process Definition ID that you provided while creating an unique version of the Request Insurance Proof service process.
    5.  Save and activate the Process Insurance Proof Request flow orchestration.
