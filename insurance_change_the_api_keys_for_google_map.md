...
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_change_the_api_keys_for_google_map.htm&language=en_US&type=5"
scraped: "2026-04-14"
...
1.  On the **SetAPIKeys** step of the Integration Procedure and change the value to your API key for `googleMapsAPIKey`.
