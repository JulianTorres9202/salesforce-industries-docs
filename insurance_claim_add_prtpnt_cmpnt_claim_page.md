---
title: "Add the Participants Component to the Claim Record Details Page"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_claim_add_prtpnt_cmpnt_claim_page.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Add the Participants Component to the Claim Record Details Page

Add the Participants Component to the Claim Record Details Page[](https://help.salesforce.com/s?language=en_US)
...
5.  Customize a tab by clicking it in the properties pane. You can select a different standard label, or click **Custom** and enter the tab name you want. For example, Participants.
6.  From the Components pane to the left, in the **Search** field, enter Claim Participants.
...
12.  To exit the Lightning App Builder and return to your Record page, click the back arrow.
