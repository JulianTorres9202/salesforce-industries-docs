...
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_direct_billing_and_auto_pay_omnistudio.htm&language=en_US&type=5"
scraped: "2026-04-14"
...
-   **[Direct Billing](https://help.salesforce.com/s/articleView?id=ind.insurance_direct_billing_omnistudio.htm&language=en_US&type=5)**  
    Policyholders, agents, and admin users can set up direct billing from the Lex Console.
-   **[Auto Pay](https://help.salesforce.com/s/articleView?id=ind.insurance_auto_pay_omnistudio.htm&language=en_US&type=5)**  
