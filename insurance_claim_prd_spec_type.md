---
title: "Create Product Specification Type"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_claim_prd_spec_type.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Create Product Specification Type

Create Product Specification Type[](https://help.salesforce.com/s?language=en_US)
...
Create Claim, ClaimDamage, and ClaimInjury product specification types.
...
1.  From Setup, in the Quick Find box, find and then select **Product Specification Type**.
2.  Create a new product specification type:
    1.  Click **New Product Specification Type**.
    2.  In Name, enter the name of the product specification type. For example, Claim, ClaimDamage, or ClaimInjury.
    3.  Save your changes.
