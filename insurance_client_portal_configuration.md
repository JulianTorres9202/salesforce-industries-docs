---
title: "Insurance Client Portal Configuration"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_client_portal_configuration.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Insurance Client Portal Configuration

Insurance Client Portal Configuration[](https://help.salesforce.com/s?language=en_US)
...
Create an experience site by using the Financial Services Client Portal template to give your customers access to the prebuilt insurance service processes.
