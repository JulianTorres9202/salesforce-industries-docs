---
title: "Auto Quote UI"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_auto_quote_ui_omnistudio.htm&language=en_US&type=5"
scraped: "2026-04-13"
...
1.  To create a new quote, do not go to the Quote page. Instead, go to the Opportunities page and choose the Opportunity you're creating the quote for.
    ...
    If the Opportunity doesn't have a pricebook:
