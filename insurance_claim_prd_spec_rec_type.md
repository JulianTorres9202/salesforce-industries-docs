---
title: "Create Product Specification Record Type"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_claim_prd_spec_rec_type.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Create Product Specification Record Type

Create Product Specification Record Type[](https://help.salesforce.com/s?language=en_US)
...
Create Claim, Claim Damage, and Claim Injury product specification record types.
...
2.  Create a new product specification type.
    ...
    2.  In Label, enter the name of the product specification record type. For example, Claim, Claim Damage, or Claim Injury.
