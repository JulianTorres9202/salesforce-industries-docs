---
title: "Insurance Footer Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_t_insurance_footer_component_647161.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Insurance Footer Component

Insurance Footer Component[](https://help.salesforce.com/s?language=en_US)
...
-   FlexCard: insFooter\_nds
    
-   LWC: cfInsFooter\_nds
    
-   Label: **Insurance Footer Newport**
    

This component is designed for desktop. Looking for the Insurance Footer component optimized for mobile? Read [Mobile Insurance Footer Component](https://help.salesforce.com/s/articleView?id=ind.insurance_mobile_insurance_footer_component_647237.htm&language=en_US&type=5 "Provide your mobile Policyholder site users with links to helpful resources with the Mobile Insurance Footer component. We have included placeholder links that you can replace with your own links.").

[](https://help.salesforce.com/s?language=en_US)

This component is styled with the Newport Design System.

Here's what the Footer component looks like when it's rendered in the Policyholder site:
...
2.  Actions Elements with links to other pages
    
    [](https://help.salesforce.com/s?language=en_US)Note
    
    The links provided out-of-the-box are placeholders. You need to update this component with your own links.
...
Policyholder site users can click links to navigate to record pages or websites, or launch OmniScripts.
...
-   Action elements that hold placeholders for you to customize
