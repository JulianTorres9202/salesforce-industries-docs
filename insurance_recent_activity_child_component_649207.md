---
title: "Insurance Recent Activity Child Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_recent_activity_child_component_649207.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Insurance Recent Activity Child Component

Insurance Recent Activity Child Component[](https://help.salesforce.com/s?language=en_US)
...
1.  The date the activity occurred.
    
2.  The title and status of the activity.
    
3.  A link to the activity record.
...
The Recent Activity Child component gathers data with the InsAccount\_GetStories Integration Procedure.
