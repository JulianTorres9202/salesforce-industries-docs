---
title: "Insurance Recent Activity Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_recent_activity_component_649144.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Insurance Recent Activity Component

Insurance Recent Activity Component[](https://help.salesforce.com/s?language=en_US)
...
-   FlexCard: insRecentActivityContainer\_nds
    
-   LWC: cfInsRecentActivityContainer\_nds
    
-   Label: **Insurance Recent Activity Container Newport**
    

This component is designed for desktop. Looking for the Insurance Recent Activity component designed for mobile? Read [Mobile Insurance Recent Activity Component](https://help.salesforce.com/s/articleView?id=ind.insurance_t_mobile_insurance_recent_activity_component_649287.htm&language=en_US&type=5 "Show your mobile Policyholder site users a snapshot of the recent activity on their policies with the Mobile Insurance Recent Activity component.").

[](https://help.salesforce.com/s?language=en_US)

This component is styled with the Newport Design System.

Here's what the Recent Activity component looks like when it's rendered in the Policyholder site:
...
2.  Recent activity displayed in a child component.
    
    Read about the Recent Activity Child component hereInsurance Recent Activity Component.
...
2.  Child FlexCard: insRecentActivityChild\_nds
...
-   **[Insurance Recent Activity Child Component](https://help.salesforce.com/s/articleView?id=ind.insurance_recent_activity_child_component_649207.htm&language=en_US&type=5)**  
