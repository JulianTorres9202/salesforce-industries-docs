---
title: "Mobile Insurance Policy Header Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_t_mobile_insurance_policy_header_component_648386.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Mobile Insurance Policy Header Component

Mobile Insurance Policy Header Component[](https://help.salesforce.com/s?language=en_US)
...
-   FlexCard: insHeaderPolicyMobile\_nds
    
-   LWC: cfInsHeaderPolicyMobile\_nds
    
-   Label: **Insurance Header Policy Mobile Newport**
    

This component is designed for mobile. Looking for the Insurance Policy Header component designed for desktop? Read Insurance Policy Header Component.

[](https://help.salesforce.com/s?language=en_US)

This component is styled with the Newport Design System.

Here's what the Mobile Insurance Policy Header component looks like when it's rendered in the Policyholder site:
...
5.  **Manage Policy** actions in a child FlexCard
    
    Child Flexcard: **insManagePolicyMobile\_nds**
...
The Mobile Insurance Policy Header component uses the InsGetPolicyDetails Omnistudio Data Mapper.

This DataRaptor extracts information about the user's policy. Fields in the FlexCard reflect the information gathered by the DataRaptor.
