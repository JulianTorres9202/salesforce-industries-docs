...
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_property_overview_516395.htm&language=en_US&type=5"
scraped: "2026-04-14"
...
-   **[Property Product Model](https://help.salesforce.com/s/articleView?id=ind.insurance_property_product_model_516441.htm&language=en_US&type=5)**  
...
-   **[Property Attribute Catalog](https://help.salesforce.com/s/articleView?id=ind.insurance_property_attribute_catalog_516721.htm&language=en_US&type=5)**  
...
-   **[Property Rating](https://help.salesforce.com/s/articleView?id=ind.insurance_property_rating_517293.htm&language=en_US&type=5)**  
...
-   **[Property Quote Business Process](https://help.salesforce.com/s/articleView?id=ind.insurance_property_quote_business_process_517662.htm&language=en_US&type=5)**  
...
-   **[Use the One-Time Payment OmniScript](https://help.salesforce.com/s/articleView?id=ind.insurance_one_time_payment_omniscript.htm&language=en_US&type=5)**  
    Use the One-Time Payment OmniScript to help your user make a single payment.
-   **[Property Claims First Notice of Loss](https://help.salesforce.com/s/articleView?id=ind.insurance_property_claims_first_notice_of_loss_519149.htm&language=en_US&type=5)**  
...
-   **[Authorize Payment for Property Claims](https://help.salesforce.com/s/articleView?id=ind.insurance_authorize_payment_for_property_claims_519421.htm&language=en_US&type=5)**  
...
-   **[Property Claims Initiate Recovery](https://help.salesforce.com/s/articleView?id=ind.insurance_property_claims_initiate_recovery_519552.htm&language=en_US&type=5)**  
    Claims adjusters have the responsibility of deciding how much money can be given for each claim. With the Claim Adjuster App, users can now quickly create a recovery record from the Insurance claim.
