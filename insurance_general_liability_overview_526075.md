---
title: "General Liability Overview"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_general_liability_overview_526075.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# General Liability Overview

General Liability Overview[](https://help.salesforce.com/s?language=en_US)
...
The General Liability line of business gives you a fully functional example of the General Liability product models, rating procedures, and business processes for quoting.
...
The product model and the rating procedure that calculate prices for General Liability products at runtime underpin all the business processes in this line of business:

-   Product Model: General Liability
-   Rating Procedure: Rating\_GeneralLiability

The product model provides the structure for the data JSON that moves through the business processes. The General Liability product model is single-instance, which means that we intend customers to insure only one business per policy. All coverages have been designed to be configured at the policy level.

To learn more about these product models, see [General Liability Product Model](https://help.salesforce.com/s/articleView?id=ind.insurance_general_liability_product_model_526108.htm&language=en_US&type=5 "To understand how the General Liability application works, you need to figure out how the General Liability product is built.").
...
-   **[General Liability Product Model](https://help.salesforce.com/s/articleView?id=ind.insurance_general_liability_product_model_526108.htm&language=en_US&type=5)**  
...
-   **[General Liability Attribute Catalog](https://help.salesforce.com/s/articleView?id=ind.insurance_general_liability_attribute_catalog_526235.htm&language=en_US&type=5)**  
    We've listed all the attributes used in the General Liability application here by the category they fall under.
-   **[General Liability Rating](https://help.salesforce.com/s/articleView?id=ind.insurance_general_liability_rating_526478.htm&language=en_US&type=5)**  
...
-   **[Commercial Quote Business Process](https://help.salesforce.com/s/articleView?id=ind.insurance_commercial_quote_business_process_1.htm&language=en_US&type=5)**  
