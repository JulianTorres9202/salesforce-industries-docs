---
title: "Mobile Insurance Policy List Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_t_mobile_insurance_policy_list_component_648702.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Mobile Insurance Policy List Component

Mobile Insurance Policy List Component[](https://help.salesforce.com/s?language=en_US)
...
-   FlexCard: insPolicyListMobile\_nds
    
-   LWC: cfInsPolicyListMobileContainer
    
-   Label: **Insurance Policy List Mobile Newport**
    

This component is designed for mobile. Looking for the Insurance Policy List component designed for desktop? Read Insurance Policy List Component.
...
This FlexCard is a container component that displays the child FlexCard (insPolicyListChildMobile\_nds) below the text element for the Your Policies label.
...
-   **[Mobile Insurance Policy List Child Component](https://help.salesforce.com/s/articleView?id=ind.insurance_t_mobile_insurance_policy_list_child_component_648761.htm&language=en_US&type=5)**  
