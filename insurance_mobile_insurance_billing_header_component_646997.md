---
title: "Mobile Insurance Billing Header Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_mobile_insurance_billing_header_component_646997.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Mobile Insurance Billing Header Component

Mobile Insurance Billing Header Component[](https://help.salesforce.com/s?language=en_US)
...
-   FlexCard: insHeaderBillingInfoMobile\_nds
    
-   LWC: cfInsHeaderBillingInfoMobile\_nds
    
-   Label: **Insurance Header Billing Info Mobile Newport**
    

This component is designed for mobile. Looking for the Insurance Billing Header component designed for desktop? Read [Insurance Billing Header Component](https://help.salesforce.com/s/articleView?id=ind.insurance_t_insurance_billing_header_component_646904.htm&language=en_US&type=5 "The Insurance Billing Header component displays a Billing info label and the policyholder's name for your Policyholder site users.").

[](https://help.salesforce.com/s?language=en_US)

This component is styled with the Newport Design System.

Here's what the Mobile Insurance Billing Header component looks like when it's rendered in the Policyholder site:

[](https://help.salesforce.com/s?language=en_US)

The parts of this component are:

1.  Returns the user to the Home page
...
1.  Active (labeled Billing Header Desktop): the state that displays when records exist
...
2.  Open (labeled Open Billing Header Desktop): the state that displays when no records exist
...
The Mobile Insurance Billing Header component calls the InsExtractAccountDetails Omnistudio Data Mapper.
