---
title: "Insurance Home Header Component"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_t_insurance_home_header_component_647404.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Insurance Home Header Component

Insurance Home Header Component[](https://help.salesforce.com/s?language=en_US)
...
-   FlexCard: insHeaderHome\_nds
    
-   LWC: cfInsHeaderHome\_nds
    
-   Label: **Insurance Header Home Newport**
    

This component is designed for desktop. Looking for the Insurance Home Header component designed for mobile? Read [Mobile Insurance Home Header Component](https://help.salesforce.com/s/articleView?id=ind.insurance_mobile_insurance_home_header_component_647480.htm&language=en_US&type=5 "Welcome your mobile user to their own personalized Policyholder site with the Mobile Insurance Home Header component.").

[](https://help.salesforce.com/s?language=en_US)

This component is styled with the Newport Design System.

Here's what the Insurance Home Header component looks like when it's rendered in the Policyholder site:
...
2.  The date they became a policyholder
