---
title: "Delete a Claim Participant"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_claim_dlt_clm_prtpnt.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# Delete a Claim Participant

Delete a Claim Participant[](https://help.salesforce.com/s?language=en_US)
...
4.  Click the dropdown menu of the participant that you want to delete, and then select **Delete**.
5.  Click **Delete**.
