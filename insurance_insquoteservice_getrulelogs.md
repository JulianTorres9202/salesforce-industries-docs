---
title: "InsQuoteService:getRuleLogs"
source: "https://help.salesforce.com/s/articleView?id=ind.insurance_insquoteservice_getrulelogs.htm&language=en_US&type=5"
scraped: "2026-04-14"
filter: "ind.insurance_"
---# InsQuoteService:getRuleLogs

InsQuoteService:getRuleLogs[](https://help.salesforce.com/s?language=en_US)
...
2.  If such rows exists, the service transforms the rows and returns to the caller in ascending order according to the **AppliedDateTime\_c** field.
...
Id of target quote for which to retrieve rule logs
